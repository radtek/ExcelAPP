...
namespace ExcelClient
{
    ...
    public class ReflectClass
    {
        ...
        public object ReflectClassIns(string Path,string ClassName)
        {
		...
		public object ReflectClassIns(string Path,string ClassName,object[] args){
			System.Reflection.Assembly ass;
			ass = System.Reflection.Assembly.LoadFile(Path);
			objType = ass.GetType(ClassName);
			if (args != null)
        ...
        public void openFuncByID(string funcid)
        {
            //Genersoft.Platform.AppFrameworkGui.Services.GSPFunctionService.Current.OpenFunc(funcid);
        }
