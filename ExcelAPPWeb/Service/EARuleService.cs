    ...
    public class EARuleService
    {
        ...
        public Model.EACmpCategory GetRuleInfo(string id)
        {
            ...
            model.Cols = Db.Fetch<Model.EACmpCateCols>(new Sql(
                @"select a.*,b.HelpID,b.IsShow,b.FType,b.IsReadOnly,b.SCols,b.RCols, b.BindCol,b.FLength,b.FPrec,b.IsMatch,b.MatchRule,b.IsReadOnly,b.IsRequire from EACmpCateCols  a left join EACatCols  b on a.FCode=b.FCode and b.RID=@1  where a.RID=@0", model.ID, model.CID));
